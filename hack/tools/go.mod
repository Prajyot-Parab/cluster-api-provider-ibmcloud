...
require (
	...
	sigs.k8s.io/cluster-api/hack/tools v0.0.0-20240910140813-945c938ce3e0
...
require (
	...
	github.com/aquasecurity/trivy-kubernetes v0.6.7-0.20240707095038-0300bc49b68b // indirect
